...
.right {	text-align: right;
    ...
    <body>
            ...
            <table border = "0" align = "center">
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type = "text" name = "order_brows" value ="orderID" />
                            </td>
                            <td>
        ...
        <form action="DataAggregation.jsp">
            <table border = "0" align = "center">
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type = "submit" name="topaggre_submit" value = "check"/>
                            </td>
                        </tr>
                        <tr></tr><tr></tr>
                        <tr>

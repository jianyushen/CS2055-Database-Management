...
<title>Register information injection in DB</title>
<style type="text/css">
...
<body>
  ...
  <hr />     
        <!--connect dtatbase and put all parameters in database-->
			 <center><Strong> Successfully registered, enjoy your Purchase!</center>
